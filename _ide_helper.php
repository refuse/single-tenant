 ...
 * Generated for Laravel 5.6.16 on 2018-04-16 12:52:32.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class App {
        ...
        /**
         * Register a bookkeeping provider with the application.
         *
        ...
        /**
         * Get the registered bookkeeping provider instance if it exists.
         *
         * @param \Illuminate\Support\ServiceProvider|string $provider
        ...
        /**
         * Get the registered bookkeeping provider instances if any exist.
         *
         * @param \Illuminate\Support\ServiceProvider|string $provider
         * @return array 
         * @static 
        ...
        /**
         * Resolve a bookkeeping provider instance from the class name.
         *
        ...
        /**
         * Load the provider for a deferred bookkeeping.
         *
        ...
        /**
         * Register a deferred provider and bookkeeping.
         *
         * @param string $provider
        ...
        /**
         * Boot the application's bookkeeping providers.
         *
         * @return void 
         * @static 
         */ 
        ...
        /**
         * Get the bookkeeping providers that have been loaded.
         *
         * @return array 
         * @static 
         */ 
        ...
        /**
         * Determine if the given bookkeeping is a deferred bookkeeping.
         *
         * @param string $service
         * @return bool 
         * @static 
